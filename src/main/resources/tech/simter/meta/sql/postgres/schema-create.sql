...
create table meta_history (
  ...
  actor        integer,
  meta_type_id integer     not null references meta_type,
  meta_doc_id  integer     not null references meta_doc,
...
comment on column meta_history.meta_type_id is 'Meta Type ID';
comment on column meta_history.meta_doc_id is 'Document Type ID';
comment on column meta_history.doc_id is 'Document instance ID';
create index on meta_history (meta_doc_id, doc_id);